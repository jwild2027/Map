...
public:
    ...
    std::optional<CenterLL> getCenter(const std::string& stateRaw,
                                      const std::string& cityRaw) const;

    std::vector<std::string> getStates() const;
    std::vector<std::string> getCities(const std::string& stateRaw) const;

    std::vector<PointLL> queryKm(const std::string& stateRaw,
                                 const std::string& cityRaw,
...
private:
    std::unordered_map<std::string,
        std::unordered_map<std::string, std::vector<PointLL>>> points_;

    std::unordered_map<std::string,
        std::unordered_map<std::string, CenterLL>> centers_;
    ...
    static bool parseRowLite(const std::string& line,
                             int idxCity, int idxState, int idxLat, int idxLon,
                             RowLite& out);
